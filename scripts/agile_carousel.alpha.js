...
(function ($) {
    ...
    $.fn.agile_carousel = function (options) {
        ...
        return this.each(function () {
            ...
            ac_html += "<div class='agile_carousel' style='overflow: hidden; position: relative; width: " + carousel_outer_width + "; height: " + carousel_outer_height + ";'>";
            ...
            for (var key in carousel_data) {
                ...
                if (carousel_data.hasOwnProperty(key)) {
                    ...
                    if (i === 1) {
                        ac_html += "<div class='slides' style='width: " + slide_width +"; height: " + slide_height + ";'>";
                    } // if
                    if (content) {
                        // render
                        ac_html += "<div class='slide_" + i + " slide' style='border: none; margin: 0; padding: 0; height: " + slide_height + "; width: " + slide_width + ";'>" + content + "</div>";
            ...
            obj.html(ac_html);
            /*obj.find(".control_set_1").css('margin-left','-'+(obj.find(".control_set_1").width()/2)+'px');*/
